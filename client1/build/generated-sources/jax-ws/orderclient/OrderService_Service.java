 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://bai2/", wsdlLocation = "http://localhost:8080/webservice/OrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://bai2/", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webservice/OrderService?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://bai2/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bai2/", "OrderServicePort"), OrderService.class, features);
    }
