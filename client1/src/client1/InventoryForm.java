...
import inventoryclient.InventoryService;
import inventoryclient.InventoryService_Service;
...
public class InventoryForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String productId = jTextField1.getText().toString();
        int quantity = Integer.parseInt(jTextField2.getText().toString());
        
        String result = port.checkInventory(productId, quantity);
